...
public class RocketLeagueDrive{
     ...
     */
    public RocketLeagueDrive(DifferentialDrive drive, Joystick stick, int leftTriggerPort, 
    int rightTriggerPort, int leftYAxis, int rightXAxis) {
        this.drive = drive;
        this.stick = stick;
